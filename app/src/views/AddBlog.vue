  ...
  <div class="main">
    <div class="box">
      ...
      <form action="">
        ...
        <button class="input" type="button" v-on:click="blogData">Add Blog</button>
      </form>
    </div>
  </div>
</template>
  ...
  methods: {
   ...
   async uploadImg(){
    ...
    async blogData(){
      ...
      if(this.imgUrl){
        const BlogData = await axiOs.post('http://localhost:8080/blog', this.blog )
